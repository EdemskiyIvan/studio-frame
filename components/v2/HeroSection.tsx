  ...
  return (
    ...
    >
      ...
      <video
        ...
        playsInline
        aria-hidden
        className="pointer-events-none absolute top-1/2 right-[6%] z-0 w-[60vw] max-w-none -translate-y-1/2 object-contain opacity-90 mix-blend-lighten lg:w-[48vw]"
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        <div className="max-w-2xl">
          ...
          <p
            className="mt-4 flex flex-wrap items-baseline gap-x-2.5 text-2xl font-semibold tracking-[-0.02em] text-ink/70 sm:text-3xl lg:text-4xl"
